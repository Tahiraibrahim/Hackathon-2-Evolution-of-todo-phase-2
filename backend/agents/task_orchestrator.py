...
class TaskOrchestrator:
    ...
    def create_task(
        ...
        Examples:
            ...
            >>> result = orchestrator.create_task(session, user_id=1, title="Buy milk")
            >>> result["success"]
            True
            >>> result["task"].title
            'Buy milk'

            >>> result = orchestrator.create_task(session, user_id=1, title="")
            >>> result["success"]
            False
            >>> result["error"]
    ...
    def list_tasks(
        ...
        Examples:
            >>> orchestrator = TaskOrchestrator()
            >>> result = orchestrator.list_tasks(session, user_id=1)
            >>> result["success"]
            True
            >>> len(result["tasks"])
            3
    ...
    def update_task(
        ...
        Args:
            ...
            user_id: ID of user requesting update (for authorization)
        ...
        Examples:
            >>> result = orchestrator.update_task(session, task_id=1, user_id=1, is_completed=True)
            >>> result["success"]
            True

            >>> result = orchestrator.update_task(session, task_id=999, user_id=1, title="New")
            >>> result["success"]
            False
            >>> result["error"]
            'Task not found'
    ...
    def delete_task(
        ...
        Examples:
            >>> result = orchestrator.delete_task(session, task_id=1, user_id=1)
            >>> result["success"]
            True

            >>> result = orchestrator.delete_task(session, task_id=999, user_id=1)
            >>> result["success"]
            False
            >>> result["error"]
            'Task not found'
